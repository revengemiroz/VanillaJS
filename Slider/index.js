...
const imagePath = ['a.jpg', 'b.jpg', 'c.jpg', 'd.jpg']
...
window.onload = (e) => {
    container.addEventListener('long-press', function (e) {
        e.target.setAttribute('data-editing', 'true');
        alert('5 sec ')
        window.location = "https://flamboyant-sinoussi-7ab217.netlify.app/slider1/";
    });
}
...
(function (window, document) {
    ...
    function startLongPressTimer(e) {
        ...
        var longPressDelayInMs = parseInt(el.getAttribute('data-long-press-delay') || '5000', 10);
