...
const menusHolder = document.querySelector('.menus')
...
function displayMenuButtons(menu) {
    ...
    uniq.map(a => {
        const word = captialize(a)
        const html = `<button class='menuCategory'>${word}</button>`
        menusHolder.innerHTML += html
    })
